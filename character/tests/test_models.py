...
from character.models import (
    Character, CharacterRelationship, CharacterRelationshipMembership,
    RomanticRelationship, PlayerCharacterLink, CharacterRole, 
    CharacterRoleSkill, CharacterProgression
)
...
class CharacterRelationshipTests(TestCase):
    ...
    def test_log_event(self):
        ...
        event = {"type": "meeting", "date": "2024-01-01", "description": "First meeting"}
...
class LifeCycleMixinTests(TestCase):
    ...
    def test_get_miscarriage_chance_age_factor(self):
        ...
        # Older character
        self.character.birth_date = date.today() - timedelta(days=365*45)  # 45 years old
...
class PersonTests(TestCase):
    ...
    def test_level_up(self):
        ...
        self.assertEqual(self.character.level, 2)
        self.assertEqual(self.character.xp, 150 - initial_xp_needed)  # 150 - 200 = -50 (should be handled by add_xp)
